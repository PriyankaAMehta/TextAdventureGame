...
class Player():
    def __init__(self):
        ...
        self.inventory = [
            items.Titan(), items.Vormir(),items.AntidoteLeaves()]
        self.hp = 100 
        self.maxHp = 200
        self.location_x, self.location_y = world.Space  # (0, 0)
        self.victory = False 
        self.experience = 0
        self.level = 0
        self.money = 30
    ...
    def lockpass(self):
        ...
        if(yourpwd == self.password):
            #sounds.SpaceSound()
            print('----Hurray! welcome to world of space')
    ...
    def level_up(self):
        ...
        print("You have reached level {}.Your hp is increased to {} and XP to {}.Titan is awarded to you".format(
